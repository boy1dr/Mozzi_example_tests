...
int carrier_freq = 100; // 55fundamental frequency
...
void updateControl(){
  ...
  deviation = width_light_level - 001; // 400 calibrate for sensor
  ...
  //lets mess with the sound a bit :)
  carrier_freq = speed_light_level;
  aCarrier.setFreq(carrier_freq); 
